<!-- This file intentionally left empty; listing detail page now composes directly in src/routes/listings/[id]/+page.svelte -->
	...
	<header class="bg-neutral-white/90 border-b border-neutral-200 shadow-sm backdrop-blur">
		<div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
			<div class="flex items-center gap-3">
				<div
					class="flex h-10 w-10 items-center justify-center rounded-lg bg-brand-primary text-neutral-white"
				>
					<i class="fa-solid fa-recycle" aria-hidden="true"></i>
				</div>
				<span class="text-2xl font-semibold">SMW</span>
			</div>
			<nav class="flex items-center gap-3">
				...
				<Button variant="ghost" size="md" class="text-neutral-600 hover:text-brand-primary">
					Sign In
				</Button>
				<Button variant="secondary" size="md" class="gap-2 text-brand-primary">Sign Up</Button>
			</nav>
		</div>
	</header>
